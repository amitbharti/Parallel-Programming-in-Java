...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            // TODO
            int countOfElements=endIndexExclusive-startIndexInclusive;
            if(countOfElements<=10000) {
    ...
    protected static double parArraySum(final double[] input) {
        ...
        //double sum = 0;
        ReciprocalArraySumTask s=new ReciprocalArraySumTask(0,input.length,input);
                // Compute sum of reciprocals of array elements
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        for(int i=0;i<numTasks;i++){
            ...
            ReciprocalArraySumTask s=new ReciprocalArraySumTask(startIndex,endIndex,input);
            ForkJoinPool.commonPool().invoke(s);
            sum += s.getValue();
        }
